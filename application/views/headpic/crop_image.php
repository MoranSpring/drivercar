...
$imgurl = base_url().'application/views/headpic/upload/'.$img;
...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <title>裁剪照片</title>
        <script src="<?= base_url() ?>application/js/jquery-1.7.1.min.js" type="text/javascript"></script>
        <script src="<?= base_url() ?>application/js/headpic/jquery.Jcrop_new.js" type="text/javascript"></script>
        <link rel="stylesheet" href="<?= base_url() ?>application/css/headpic/jquery.Jcrop.min.css" type="text/css" />
        ...
        <style type="text/css">
            ...
            /*控制预览图大小*/
            .crop_preview{float:left;margin-left:20px;width:100px;height:100px;overflow:hidden;}
            .clear{clear:both}
            .btn{cursor:pointer}
            .tl{text-align:left}
            ...
            $(document).ready(function () {
                ...
                $("#confirmOk").click(function () {
                    if (parseInt($('#w').val())) {
                        ...
                        var w = $("#w").val();
                        var h = $("#h").val();
                        var crop_submit="<?= base_url() ?>index.php/info_change/submitHeadImg";
                        $.post(crop_submit, {pic_name: pic_name, x: x, y: y, w: w, h: h}, function (data) {
                            ...
                            if (data.status == 1) {
                                ...
                                if (_call_back && win[_call_back] && typeof (win[_call_back]) == 'function') {
                                    try {
                                        ...
                                        win[_call_back].call(this,data.cdnurl);
                                        art.dialog.close();
                                    } catch (e) {
                                        alert('确认异常');
                                    };
        ...
        <div class="zxx_out_box">
            <div class="zxx_main_con">
                <div class="zxx_test_list">
                    <div class="rel">
                        <img id="xuwanting" src="<?php echo $imgurl; ?>" style="display: none;"/>
                        <span id="preview_box" class="crop_preview"><img id="crop_preview" src="<?php echo $imgurl; ?>"/></span>
                    </div>
                </div>
            </div>
            <div class="zxx_footer">
                <form>
                    ...
                    <input type="hidden" id="pic_name" name="pic_name" value="<?php echo $imgurl; ?>"/>
