...
<div id="content" class="clearfix">
    <div id="con-left">
        <ul>
            ...
            <li><a href="<?= base_url() . 'index.php/first/book_manage' ?>"><span>预约管理</span></a></li>
            <li><a href="<?= base_url() . 'index.php/first/coach_info' ?>"><span>学习反馈</span></a></li>
            <li><a href="<?= base_url() . 'index.php/first/point_manage' ?>"><span>我的积分</span></a></li>
            <li><a href="<?= base_url() . 'index.php/first/sch_info' ?>"><span>申诉</span></a></li>
            <li><a href="<?= base_url() . 'index.php/first/my_partner' ?>"><span>我的学友</span></a></li>
        </ul>
    </div>
    <div id="con-right">
        <div id="con-nav">
