...
<div class='am-margin-top-sm'>
    ...
    <section class="am-panel am-panel-default"  style='border-color:#ddd;'>
        ...
        <div class="am-panel-bd" style='padding:5px;; color:#888;'>
            <span style="line-height:27px;;display: block;">每课时收费：<span class="ml-color-currency" style="font-size:1.3em"><?= $coach_cls_cost ?></span> C币</span>
            <span style="line-height:27px;;display: block;">全程教学费：<span class="ml-color-currency" style="font-size:1.3em"><?= $coach_all_cost ?></span> 元</span>
    </section>
    <section class="am-panel am-panel-default"  style='border-color:#ddd;'>
        <header class="am-panel-hd" style='background: #fff'>
            <div class="clearfix">
