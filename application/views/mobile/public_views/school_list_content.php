<li class="am-padding-top-xs am-padding-bottom-xs ml-ontouch">
    <div  onclick="detail(this);" class="am-g this_school" value='<?=$jp_id?>'>
        <div class="am-u-sm-4  am-u-md-4" style="padding:3px;">
            <img class="am-img am-img-thumbnail am-radius" src="<?=$jp_imge?>@!mob-nails" style="height:75px;"/>
        </div>
        <div class="am-u-sm-8 am-u-md-8" style="font-size: 0.8em;">
            <div class="am-g" style="font-size: 1.4em;line-height: 35px;">
                <span class="am-fl" style="color:#555;text-overflow:ellipsis;width:65%;overflow:hidden;white-space:nowrap; "><?=$jp_name?></span>
                <span class="am-fr" style="font-weight: bold;color:#f00;margin-right: 5px;">4300元</span>
            </div>
