<body>
    ...
    <form class="am-form"  id="form-login" method="post" onsubmit="return checkForm(this)" action="<?= base_url() ?>index.php/first/login_psw_check">
        <div class="am-input-group am-margin">
            ...
            <input id="name" name="name"  type="text" class="am-form-field" autocomplete="off" value="" onfocus="check_onfocus()" onblur="check_onbulr(this.value)" placeholder="账户名/邮箱/手机号">
        </div>
        <div class="am-input-group  am-margin">
