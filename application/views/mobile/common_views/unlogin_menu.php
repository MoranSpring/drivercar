                ...
                <li class=""style="background:#333;border-bottom: 1px dotted #999;">
                    <div class="am-g am-margin-sm">
                        ...
                        <div class="am-u-sm-7 am-u-md-7" style="color:#fff">
                            <lable type="button" class="am-btn-xl am-fl ml-btn-normal am-radius" onclick="window.location='<?= base_url()?>index.php/mobile/login'" style=" width:100px;text-align: center">请登录</lable>
                        </div>
