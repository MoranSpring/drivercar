<html>
    <head>
        ...
        <link rel="shortcut icon" href="http://image.52drivecar.com/images/iconfont-suo.png" type="image/x-icon">
        <script src="http://libs.baidu.com/jquery/2.0.0/jquery.min.js"></script>
        <script src="http://image.52drivecar.com/js/jquery.cxselect.min.js" type="text/javascript"></script>
        ...
        <link type="text/css" href="http://image.52drivecar.com/css/ml.css" rel="stylesheet">
    </head>
    <body  style="background:url('http://image.52drivecar.com/images/mobile/bg_EEE.png');">
