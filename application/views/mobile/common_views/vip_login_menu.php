            ...
            <ul class="am-menu-nav am-avg-sm-1">
                <li class=""style="background:#333;border-bottom: 1px dotted #999;">
                    <div class="am-g am-margin-sm">
                        <div class="am-u-sm-4 am-u-md-4">
                            <img class="am-circle" src="http://image.52drivecar.com/coach_imges/1428902550.jpg@!nail250" height="80px" height="80px"/>
                        </div>
                        <div class="am-u-sm-7 am-u-md-7" style="color:#fff">
                            <span class=" am-text-lg am-fl"  style="color:#fff">黄建新</span>
                            <lable type="button" class="am-btn-sm am-fr am-btn-warning" style="width:50px;text-align: center">退出</lable>
                        </div>
                ...
                <li class="am-parent">
                    ...
                    <ul class="am-menu-sub am-collapse">
                        ...
                        <li class="">
                            <a href="##" class=""style="background:#555;border-bottom: 1px dashed #999;color: #ddd">预约培训</a>
                        </li>
                        <li class="">
