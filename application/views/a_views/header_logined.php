    ...
    <nav class="clearfix">
        <ul class="hea-ul">
            ...
            <li class="user_header">
                <a href="<?= base_url() ?>index.php/first/login"><span><?=$username?> <img src='http://www.xcwljy.cn/images/pixel.gif'style="float:right;vertical-align:middle;" class="user_header_img"/></span></a>
